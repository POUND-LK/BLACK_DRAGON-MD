...
async function sessdl() {
  try {
    ...
    const base64Data = sess.SESSION_ID.split("BLACK_DRAGON~")[1];
    if (!base64Data) {
...
async function connectToWA() {
  ...
  //===========================
  console.log("🔥 BLACK DRAGON MD is starting...");
  ...
  conn.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      let up = `
          🚀 **© 𝙱𝙻𝙰𝙲𝙺_𝙳𝚁𝙰𝙶𝙾𝙽-𝙼𝙳 ⬆️ Connected Successfully!** ✅ 
          
          --- **🎉 Welcome to © 𝙱𝙻𝙰𝙲𝙺_𝙳𝚁𝙰𝙶𝙾𝙽-𝙼𝙳 🇱🇰!** 🎉 
      ...
      conn.sendMessage(conn.user.id, {
        text: up,
        contextInfo: {
          mentionedJid: ["94775700815@s.whatsapp.net"], // specify mentioned JID(s) if any
          groupMentions: [],
          forwardingScore: 999,
          isForwarded: true,
          forwardedNewsletterMessageInfo: {
            newsletterJid: "120363403061888196@newsletter",
            newsletterName: "𝙱𝙻𝙰𝙲𝙺_𝙳𝚁𝙰𝙶𝙾𝙽-𝙼𝙳",
            serverMessageId: 999,
          },
          externalAdReply: {
            title: "⍟ 𝘗𝘙𝘌𝘚𝘌𝘕𝘛 𝘉𝘠 𝘋𝘐𝘓𝘐𝘚𝘏𝘈 𝘛𝘌𝘊𝘏 ㊧",
            body: " 𝙱𝙻𝙰𝙲𝙺_𝙳𝚁𝙰𝙶𝙾𝙽-𝙼𝙳",
            mediaType: 1,
...
if (!app) return;
app.get("/", (req, res) => {
  res.send("hey I am alive, BLACK_DRAGON-MD Is started✅");
});
app.listen(port, () =>
